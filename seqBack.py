#!/usr/bin/env python
"""
map un-bisulfite converted reads to an insilico converted genome using bwa mem.
A command to this program like:

    python bw4.py --reference ref.fa A.fq B.fq
...
def handle_reads(alns, set_as_failed):
    ...
    for aln in alns:
        ...
        if mate_direction not in "*=":
            ...
            aln.chrom_mate = re.sub(":\S+$","", aln.chrom_mate)
...
def main(args=sys.argv[1:]):
    ...
    fa = ""
    as_bam(cmd, fa, set_as_failed = None)
